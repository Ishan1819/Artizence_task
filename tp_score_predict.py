...
# #     }
# # # ----------------------------------------------------------------------------
# # # 4. CLASSIFIER METRICS (Winner Prediction)
# # # ----------------------------------------------------------------------------
# # yw_pred = clf.predict(Xw_te)
# # yw_proba = clf.predict_proba(Xw_te)[:, 1]

# # print("\n--- Winner Classifier Metrics ---")
# # print("Accuracy Score       :", accuracy_score(yw_te, yw_pred))
# # print("ROC AUC Score        :", roc_auc_score(yw_te, yw_proba))
# # print("Confusion Matrix     :\n", confusion_matrix(yw_te, yw_pred))
# # print("Classification Report:\n", classification_report(yw_te, yw_pred))

# # # ----------------------------------------------------------------------------
# # # 5. REGRESSOR METRICS (Loser Score Prediction)
# # # ----------------------------------------------------------------------------
...
# # print("\n--- Loser Score Regressor Metrics ---")
# # print("Mean Absolute Error  :", mae)
# # print("Mean Squared Error   :", mse)
# # print("Root Mean Squared Err:", rmse)
# # print("R² Score             :", r2)
...
# 3. TRY IT OUT
# ----------------------------------------------------------------------------
out = predict_match_score("Delhi Capitals", "Kolkata Knight Riders")
print(out)
